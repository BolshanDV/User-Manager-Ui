...
export default {
  ...
  computed: {
    ...mapGetters('calendarCancelled', ['calendarIntervalFlag', 'monthWeek', 'calendarDateInterval', 'componentKey', 'totalIncome', 'calendarEndStart'])
  },
  methods: {
    ...mapActions('calendarCancelled', ['OUTPUT_INTERVAL', 'CHANGE_CALENDAR_DATE', 'WEEK_REVENUE'])
  },
  watch: {
    calendar: function (){
