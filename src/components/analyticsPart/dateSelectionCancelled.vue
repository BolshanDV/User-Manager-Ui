...
<!--            &lt;!&ndash;             :class="{selected: monthWeek}"&ndash;&gt;-->
<!--            Неделя-->
<!--          </div>-->
<!--          <div class="btn_interval"-->
...
<!--    return {-->
<!--      calendar: new Date(),-->
<!--      title: 'dateSelectionSuccessfulPayments'-->
<!--    };-->
<!--  },-->
<!--  computed: {-->
<!--    ...mapGetters('calendarSuccessfulPayments', ['calendarIntervalFlag', 'monthWeek', 'calendarDateInterval', 'componentKey', 'totalIncome', 'calendarEndStart'])-->
<!--  },-->
<!--  methods: {-->
<!--    ...mapActions('calendarSuccessfulPayments', ['OUTPUT_INTERVAL', 'CHANGE_CALENDAR_DATE', 'WEEK_REVENUE'])-->
<!--  },-->
<!--  watch: {-->
<!--    calendar: function (){-->
